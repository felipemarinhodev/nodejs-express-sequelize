...
router.put('/pessoas/:estudante_id/matriculas/:id', (req, res) => pessoaController.atualiza(req, res));
router.delete('/pessoas/:estudante_id/matriculas/:id', (req, res) => pessoaController.exclui(req, res));
